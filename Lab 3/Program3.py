...
QUESTIONS_PATH=['questions/q1.txt','questions/q2.txt','questions/q3.txt','questions/q4.txt','questions/q5.txt']
ANSWERS_PATH=['answers/a1.txt', 'answers/a2.txt','answers/a3.txt','answers/a4.txt','answers/a5.txt']
...
new_ques_freq=findFrequencyOfWordInDocument('new_question.txt');
